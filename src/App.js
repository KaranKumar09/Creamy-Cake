...
// src/App.js
import CustomizedCake from './components/shared/CustomizedCake/CustomizedCake';
...
import {
  ...
  SignupForm,
  Wishlist,
  CustomizeCake, // Import CustomizeCake
} from "components";
  ...
  return (
    <div className="App pagewrapper">
      ...
      <Routes>
        ...
        <Route path="/customize-cake" element={<CustomizedCake />} /> {/* Add route */}
