...
function Navigation() {
  ...
  // Handle success message for cake customization
  const handleCustomizationSuccess = () => {
    toast.success("Redirecting to Cake Customization!", {
      position: "bottom-right",
      autoClose: 2000,
      draggable: true,
    });
    navigate("/customize-cake"); // Navigate to the Customize Cake page
  };
